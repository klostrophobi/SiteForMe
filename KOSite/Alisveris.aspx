<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Alisveris.aspx.cs" Inherits="KOSite.Alisveris" %>
...
<body>
    ...
    <div class="site-wrap">
            ...
            <nav class="site-navigation text-right text-md-center" role="navigation">
                <div class="container">
                    <ul class="site-menu js-clone-nav d-none d-md-block">
                        ...
                        <li class="active"><a href="Alisveris.aspx">Shop</a></li>
                        <li><a href="#">Catalogue</a></li>
                        <li><a href="#">New Arrivals</a></li>
                        <li><a href="BizeUlasin.aspx">Contact</a></li>
                    </ul>
                </div>
            </nav>
        </header>
        ...
        <div class="bg-light py-3">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 mb-0"><a href="Default.aspx">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Shop</strong></div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                                <div class="block-4 text-center border">
                                    ...
                                    <div class="block-4-text p-4">
                                        <h3><a href="SecilenDetay.aspx">Corater</a></h3>
                            ...
                            <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                                <div class="block-4 text-center border">
                                    ...
                                    <div class="block-4-text p-4">
                                        <h3><a href="SecilenDetay.aspx">Polo Shirt</a></h3>
                                        <p class="mb-0">Finding perfect products</p>
                                        <p class="text-primary font-weight-bold">$50</p>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                                <div class="block-4 text-center border">
                                    <figure class="block-4-image">
                                        <a href="SecilenDetay.aspx">
                                            <img src="images/cloth_3.jpg" alt="Image placeholder" class="img-fluid" /></a>
                                    </figure>
                                    <div class="block-4-text p-4">
                                        <h3><a href="SecilenDetay.aspx">T-Shirt Mockup</a></h3>
                                        <p class="mb-0">Finding perfect products</p>
                                        <p class="text-primary font-weight-bold">$50</p>
                                    </div>
                                </div>
