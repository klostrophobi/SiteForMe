<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sepet.aspx.cs" Inherits="KOSite.Sepet" %>
                    ...
                    <div class="col-md-6 pl-5">
                        <div class="row justify-content-end">
                            <div class="col-md-7">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='Checkout.aspx'">Proceed To Checkout</button>
                                    </div>
                                </div>
                            </div>
                        </div>
