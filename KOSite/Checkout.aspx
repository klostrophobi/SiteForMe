<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="KOSite.Checkout" %>
...
<body>
    ...
    <div class="site-wrap">
            ...
            <nav class="site-navigation text-right text-md-center" role="navigation">
                <div class="container">
                    <ul class="site-menu js-clone-nav d-none d-md-block">
                        ...
                        <li><a href="Alisveris.aspx">Shop</a></li>
        ...
        <div class="bg-light py-3">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 mb-0"><a href="Default.aspx">Home</a> <span class="mx-2 mb-0">/</span> <a href="Sepet.aspx">Cart</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Checkout</strong></div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row mb-5">
                            <div class="col-md-12">
                                ...
                                <div class="p-3 p-lg-5 border">
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='Tesekkur.aspx'">Place Order</button>
                                    </div>
